...
export const GAMES: CatalogTitle[] = [
  game("game-botw", "The Legend of Zelda: Breath of the Wild", 2017, ["Adventure", "Open World", "Action"], 1, ["Nintendo"]),
  game("game-hades", "Hades", 2020, ["Action", "Roguelike", "Indie"], 2, ["PC"]),
  game("game-stardew", "Stardew Valley", 2016, ["Simulation", "Casual", "Indie"], 2, ["PC"]),
  game("game-elden-ring", "Elden Ring", 2022, ["Soulslike", "Action", "RPG", "Open World"], 1, ["PlayStation", "Xbox", "PC"]),
  game("game-portal-2", "Portal 2", 2011, ["Puzzle", "Shooter"], 2, ["PC", "PlayStation", "Xbox"]),
  ...
  game("game-last-of-us", "The Last of Us", 2013, ["Action", "Adventure", "Survival", "Horror", "Stealth"], 1, ["PlayStation"]),
  game("game-minecraft", "Minecraft", 2011, ["Sandbox", "Open World", "Survival"], 1, ["PC"]),
  game("game-hollow-knight", "Hollow Knight", 2017, ["Metroidvania", "Adventure", "Indie"], 3, ["PC"]),
  game("game-bg3", "Baldur's Gate 3", 2023, ["RPG"], 2, ["PC"]),
  game("game-animal-crossing", "Animal Crossing: New Horizons", 2020, ["Simulation", "Casual"], 1, ["Nintendo"]),
  game("game-rdr2", "Red Dead Redemption 2", 2018, ["Action", "Adventure", "Open World"], 1, ["PlayStation", "Xbox"]),
  game("game-tetris-effect", "Tetris Effect", 2018, ["Rhythm", "Puzzle"], 3, ["PlayStation"]),
  ...
  game("game-slay-the-spire", "Slay the Spire", 2019, ["Roguelike", "Strategy", "Indie"], 3, ["PC"]),
  game("game-super-metroid", "Super Metroid", 1994, ["Metroidvania", "Adventure", "Platformer"], 3, ["Nintendo"]),
  game("game-it-takes-two", "It Takes Two", 2021, ["Adventure", "Platformer", "Party"], 2, ["PlayStation", "Xbox", "PC"]),
  game("game-persona-5", "Persona 5 Royal", 2019, ["JRPG", "RPG"], 2, ["PlayStation"]),
  game("game-among-us", "Among Us", 2018, ["Party", "Casual", "Indie"], 1, ["Mobile"]),
  game("game-chrono-trigger", "Chrono Trigger", 1995, ["JRPG", "RPG"], 3, ["Nintendo"]),
  ...
  game("game-cruelty-squad", "Cruelty Squad", 2021, ["Immersive Sim", "Shooter", "Indie"], 5, ["PC"]),
  ...
  game("game-halo", "Halo: Combat Evolved", 2001, ["Shooter"], 1, ["Xbox"]),
  game("game-wow", "World of Warcraft", 2004, ["RPG"], 1, ["PC"]),
  game("game-bioshock", "BioShock", 2007, ["Immersive Sim", "Shooter", "Horror"], 2, ["PC", "Xbox"]),
  game("game-left-4-dead-2", "Left 4 Dead 2", 2009, ["Shooter"], 2, ["PC", "Xbox"]),
  game("game-dark-souls", "Dark Souls", 2011, ["Soulslike", "Action", "RPG"], 2, ["PlayStation", "Xbox"]),
  game("game-skyrim", "The Elder Scrolls V: Skyrim", 2011, ["RPG", "Open World", "Adventure", "Sandbox"], 1, ["PlayStation", "Xbox", "PC"]),
  ...
  game("game-overwatch", "Overwatch", 2016, ["Shooter"], 1, ["PC", "PlayStation", "Xbox"]),
  game("game-horizon", "Horizon Zero Dawn", 2017, ["Action", "Adventure", "Open World"], 2, ["PlayStation"]),
  game("game-into-the-breach", "Into the Breach", 2018, ["Tactics", "Strategy", "Indie"], 4, ["PC", "Nintendo"]),
  game("game-sekiro", "Sekiro: Shadows Die Twice", 2019, ["Soulslike", "Action", "Stealth"], 2, ["PlayStation", "Xbox", "PC"]),
  game("game-death-stranding", "Death Stranding", 2019, ["Adventure", "Action"], 3, ["PlayStation"]),
  game("game-hades-already", "A Short Hike", 2019, ["Adventure", "Indie", "Casual"], 4, ["PC"]),
  game("game-animal-well", "Animal Well", 2024, ["Metroidvania", "Puzzle", "Indie"], 4, ["PC", "Nintendo", "PlayStation"]),
  game("game-balatro", "Balatro", 2024, ["Roguelike", "Indie"], 2, ["PC"]),
  game("game-metaphor", "Metaphor: ReFantazio", 2024, ["JRPG", "RPG"], 3, ["PlayStation", "Xbox", "PC"]),
];
...
export const SEARCH_FALLBACK: CatalogTitle[] = [
  ...
  game("search-hades", "Hades", 2020, ["Action", "Roguelike", "Indie"], 2, ["PC"]),
