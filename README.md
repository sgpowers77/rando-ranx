...
11. Reset progress asks for confirmation then clears logs, Discard, Watch tags, Queue, remembered skip, filters, and searched titles. The catalog stays. Palettes are not reset.
